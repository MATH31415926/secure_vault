...
TRANSLATIONS = {
    'zh': {
        ...
        'pin_setup_title': 'Secure Vault - 配置 PIN 码',
        'pin_verify_title': 'Secure Vault - 验证 PIN 码',
        'setup_pin': '设置 PIN 码',
        'subtitle_pin_protection': '请设置一个安全的 PIN 码来保护您的数据',
        'pin_label': 'PIN 码:',
        'confirm_pin_label': '确认 PIN 码:',
        'placeholder_enter_pin': '输入 PIN 码 (至少 4 位)',
        'placeholder_confirm_pin': '再次输入 PIN 码',
        'strength_label': '强度:',
        'btn_confirm': '确认',
        'btn_unlock': '解锁',
        'subtitle_unlock': '请输入 PIN 码解锁',
        'btn_exit': '退出',
        'label_success': '成功',
        'label_error': '错误',
        'label_unknown': '未知',
        'label_root': '根目录',
        'label_selected_item': '选中的项目',
        
        # Errors & Validation
        'error_pin_min_length': 'PIN 码至少需要 4 位',
        'error_pin_mismatch': '两次输入的 PIN 码不一致',
        'error_pin_required': '请输入 PIN 码',
        'error_pin_invalid': 'PIN 码错误',
        
        # Tooltips
        'tooltip_switch_repo': '切换仓库',
        'tooltip_change_pin': '修改 PIN 码',
        'tooltip_theme': '切换深色/浅色模式',
        
        # Repository Management
        'repo_mgr_title': 'Secure Vault - 仓库管理',
        'repo_mgr_main_title': '选择或创建仓库',
        'repo_mgr_subtitle': '仓库用于存储加密的数据块。请选择一个仓库或创建新仓库。双击名称可重命名。',
        'repo_col_name': '名称',
        'repo_col_path': '路径',
        'repo_col_used': '已用容量',
        'repo_col_limit': '容量限制',
        'btn_create_repo': '➕ 创建仓库',
        'btn_import_repo': '📥 导入仓库',
        'btn_delete_repo': '🗑️ 删除仓库',
        'btn_enter_repo': '进入仓库',
        'dialog_delete_repo_title': '删除仓库',
        'dialog_delete_repo_msg': "确定要删除仓库 '{name}' 吗？\n\n⚠️ 此操作将删除：\n• 仓库配置\n• 所有加密的文件块\n• 相关的数据库记录\n\n此操作无法撤销！",
        'dialog_import_repo_title': '选择仓库配置文件',
        'dialog_import_repo_filter': '配置文件 (config.json);;所有文件 (*)',
        'msg_import_success_renamed': '仓库已导入。由于名称重复，已重命名为：\n\n{name}',
        'msg_import_success': "仓库 '{name}' 已成功导入！",
        'msg_import_failed': '导入失败',
        'msg_import_error': '导入时发生错误：\n\n{error}',
        'dialog_rename_repo_title': '重命名仓库',
        'dialog_rename_repo_msg': '请输入新的仓库名称：',
        'msg_rename_failed': '重命名失败',
        'dialog_capacity_title': '修改容量限制',
        'dialog_capacity_msg': '请输入新的容量限制 (GB)：',
        'error_repo_not_found': '仓库不存在',
        'error_repo_path_not_found': '仓库路径已不存在：\n\n{path}\n\n仓库可能已被移动或删除。请检查路径或删除此仓库记录。',
        'error_repo_connect': '连接到仓库时发生错误：\n\n{error}',
        'btn_browse': '浏览...',
        'btn_cancel': '取消',
        'btn_create': '创建',
        'placeholder_repo_name': '例如：工作仓库',
        'placeholder_select_path': '选择存储位置',
        'disk_info': '磁盘总容量: {total}',
        'error_repo_name_required': '请输入仓库名称',
        'error_repo_name_exists': '此仓库名称已存在',
        'error_repo_path_required': '请选择存储路径',
        'error_repo_path_exists': '此路径已被其他仓库使用',
        'error_capacity_too_small': '容量限制 ({size}) 不能超过磁盘大小 ({total})',
        ...
        'status_ready': '就绪',
        'status_encrypting': '正在加密...',
        'status_decrypting': '正在解密...',
        'status_cancelling': '正在取消...',
        'status_cleaning': '正在清理数据...',
        'msg_cleaning_orphans': '清理了 {size} MB 的孤立数据',
        'msg_files_loaded': '文件列表已加载',
        'info_used': '已用: {used} / {total}',
        'dialog_task_in_progress_title': '任务进行中',
        'dialog_task_in_progress_msg': '正在处理任务，请稍后再试',
        'dialog_restart_warning_title': '任务进行中',
        'dialog_restart_warning_msg': '当前有任务正在执行，更改设置将取消该任务并进行清理，然后重启程序。\n\n确定要继续吗？',
        'dialog_confirm_restart_title': '确认重启',
        'dialog_confirm_restart_msg': '更改需要重启程序才能生效，是否确定重启？',
        'dialog_repo_not_found_title': '仓库不存在',
        'dialog_repo_not_found_msg': '选定的仓库已不存在，程序将退出。',
        'dialog_repo_deleted_title': '仓库已删除',
        'dialog_repo_deleted_msg': '当前使用的仓库已被删除，程序将退出。请重新启动并选择新仓库。',
        'dialog_task_busy_title': '任务正在进行',
        'dialog_task_busy_msg': "当前正在执行「{name}」任务，请等待完成后再执行其他操作。",
        'dialog_switch_blocked_msg': "当前正在执行「{name}」任务，请等待任务完成后再切换仓库。",
        'dialog_exit_warning_title': '任务进行中',
        'dialog_exit_warning_msg': '当前有任务正在执行，关闭程序将在下一次自动启动。\n\n确定要退出吗？',
        'exit_confirm_title': '退出',
        'exit_confirm_msg': '确定要退出 Secure Vault 吗？',
        
        # Key Setup
        'key_setup_title': 'Secure Vault - 配置密钥',
        'key_setup_main_title': '配置主密钥',
        'key_setup_subtitle': '选择密钥生成方式。主密钥将用于加密所有文件。',
        'radio_random_key': '随机生成密钥 (推荐)',
        'radio_manual_key': '手动输入密钥',
        'label_random_key': '生成的密钥 (请妥善保存):',
        'btn_regenerate': '重新生成',
        'btn_copy_key': '复制密钥',
        'label_manual_key': '输入密钥 (32 字节 / 64 个十六进制字符):',
        'placeholder_hex_64': '输入 64 个十六进制字符',
        'label_backup_warning': '⚠️ 请务必备份您的密钥！丢失密钥将无法恢复数据。',
        'msg_key_copied_title': '已复制',
        'msg_key_copied_msg': '密钥已复制到剪贴板。请妥善保存！',
        'error_hex_length': '需要 64 个字符，当前 {count} 个',
        'error_hex_invalid': '请输入有效的十六进制字符',
        'dialog_confirm_key_title': '确认密钥',
        'dialog_confirm_key_msg': '您确定已经安全保存了密钥吗？\n\n丢失密钥将导致所有数据无法恢复！',
        
        # Context Menu & Actions
        'menu_new_folder': '📁 新建文件夹',
        'menu_rename': '📝 重命名',
        'menu_edit_comment': '💬 编辑注释',
        'menu_export_decrypted': '📤 解密导出',
        'menu_delete': '🗑️ 删除项目',
        'dialog_rename_title': '重命名',
        'dialog_rename_msg': '输入新名称:',
        'dialog_edit_comment_title': '编辑注释',
        'dialog_edit_comment_msg': '输入注释:',
        'dialog_delete_confirm_title': '确认删除',
        'dialog_delete_confirm_msg_single': "确定要删除 '{name}' 吗？",
        'dialog_delete_confirm_msg_multiple': '确定要删除选中的 {count} 个项目吗？',
        'dialog_delete_confirm_suffix': '\n\n此操作不可恢复！',
        'dialog_export_title': '选择导出目录',
        'dialog_new_folder_title': '新建文件夹',
        'dialog_new_folder_msg': '文件夹名称:',
        'placeholder_new_folder': '新建文件夹',
        'dialog_name_clash_title': '名称冲突',
        'dialog_name_clash_msg': "文件夹 '{name}' 已存在。",
        'log_clear': '清除日志',
        'msg_finished': '完成',
        'msg_cancelled': '已取消',
        'msg_cleanup_finished': '清理完成',
        'error_cleanup_failed': '清理失败',
        'msg_items_count': '{count} 个项目',
        'msg_exported_count': '已导出 {count} 个项目',
        'msg_imported_count': '已导入 {count} 个项目',
        'msg_deleted_count': '成功删除 {count} 个项目',
        'dialog_export_failed_title': '导出失败',
        'dialog_export_failed_msg': "无法导出 '{name}'：\n部分数据块丢失。\n\n丢失的块：\n",
        'error_export_generic': '导出时遇到错误: {error}',
        'error_create_folder_failed': '创建文件夹失败: {error}',
        'log_item_finished': '{action} 完成: {item}',
        
        # PIN Change
        'pin_change_title': '修改 PIN 码',
        'label_current_pin': '当前 PIN 码:',
        'label_new_pin': '新 PIN 码:',
        'label_confirm_new_pin': '确认新 PIN 码:',
        'placeholder_current_pin': '输入当前 PIN 码',
        'placeholder_new_pin': '输入新 PIN 码 (至少 4 位)',
        'placeholder_confirm_new_pin': '再次输入新 PIN 码',
        'btn_change': '修改',
        'error_current_pin_required': '请输入当前 PIN 码',
        'error_new_pin_min_length': '新 PIN 码至少需要 4 位',
        'error_new_pin_mismatch': '两次输入的新 PIN 码不一致',
        'error_new_pin_same_as_current': '新 PIN 码不能与当前 PIN 码相同',
        'msg_pin_change_success': 'PIN 码已成功修改！',
        ...
        'tree_col_items': '项目数',
        'tree_col_comment': '注释',
        'label_encrypt_error': '<加密错误>',
        
        # Operations & Logging
        'log_found_pending': '发现未完成的任务 (ID: {id}, 类型: {type}, Status: {status})',
        'log_resuming_task': '正在恢复任务: {type}',
        'log_resume_cleanup': '正在恢复取消清理: {type}',
        'log_resume_failed_missing': '无法恢复导入: 源文件已丢失 - {path}...',
        'log_resume_failed_vault': '无法恢复导入: 仓库加密存储路径不存在',
        'log_resume_success': '验证通过，正在恢复 {type} 任务: {id}',
        'log_resume_failed_export_missing': '无法恢复导出: 目标路径已丢失 - {path}',
        'log_resume_failed_export_parent': '无法恢复导出: 目标父目录已删除 - {path}',
        'log_resume_failed_blocks': '无法恢复导出: 仓库文件数据块丢失 - {name}',
        'log_resume_failed_no_files': '无法恢复导出: 找不到任何待导出的虚拟文件',
        'log_task_failed': '恢复 {type} 任务失败: {error}',
        'log_startup': '启动',
        'log_repo_info': '仓库: {name}',
        'log_force_cleanup': '执行延迟清理: {id}',
        'log_theme_switch': '主题切换',
        'log_prepare_restart': '准备重启并切换到 {mode} 模式',
        'log_system': '系统',
        'log_restart_app': '程序正在重启以应用主题更改',
        'log_security': '安全',
        'log_pin_changed': 'PIN 码已修改',
        'log_switch_repo': '切换仓库',
        'log_switch_to': '切换到: {name}',
        'log_repo_not_found_exit': '仓库不存在，程序退出',
        'log_repo_deleted_exit': '当前仓库已删除，程序退出',
        'log_move': '移动',
        'log_file_id': '文件 ID {id}',
        'log_rename_to': '文件重命名为: {name}',
        'log_rename_arrow': '-> {name}',
        'log_delete': '删除',
        'log_new_folder': '新建文件夹',
        'log_new_folder_at': '{name} (在 {parent})',
        'log_rename': '重命名',
        'log_comment_update': '注释更新',
        'log_comment_for': '{name} (ID {id})',
        'log_export': '导出',
        'log_export_target': '目标: {path}',
        'log_cancelled_by_user': '操作已被用户取消',
        'log_cancelled_rolled_back': '操作已取消并回滚',
        'log_pause_on_exit': '程序关闭，任务已暂停，下次启动将自动恢复',
        'log_cleanup_recorded': '清理已记录，正在执行清空操作...',
        'log_cleanup_finished': '清理完成，操作记录已删除',
        'log_exit': '退出',
        'log_app_closed': '应用程序关闭',
        'error_restart_failed': '无法启动新实例: {error}',
        'type_import': '导入',
        'type_export': '导出',
        'mode_dark': '深色',
        'mode_light': '浅色',
        'label_encrypt_import': '加密导入',
        'label_decrypt_export': '解密导出',
        'label_delete': '删除',
        'label_rename': '重命名',
        'label_comment': '编辑注释',
        ...
        # Time Estimates
        'eta_soon': '即将完成',
        'eta_seconds': '剩余 {seconds}s',
        'eta_minutes': '剩余 {m}m {s}s',
        'eta_hours': '剩余 {h}h {m}m',
        ...
        'exit_dialog_msg': '当前有正在运行的任务，退出将暂停任务并可在下次启动时自动恢复。是否退出？',
    },
    'en': {
        # App & Titles
        'app_name': 'Secure Vault',
        ...
        'btn_create_repo': '➕ Create Repo',
        'btn_import_repo': '📥 Import Repo',
        'btn_delete_repo': '🗑️ Delete Repo',
        ...
        'label_backup_warning': '⚠️ Please backup your key! Data cannot be recovered without it.',
        ...
        'menu_rename': '📝 Rename',
        'menu_edit_comment': '💬 Edit Comment',
        'menu_export_decrypted': '📤 Export Decrypted',
        'menu_delete': '🗑️ Delete Item',
